...
namespace HDTween
{
    public class ChangeColorToTween : ITween
    {
        ...
        public ChangeColorToTween(Graphic graphic, UnityEngine.Color targetColor, float duration, bool unscaled = false)
        {
            _graphic = graphic;
        ...
        public ChangeColorToTween(SpriteRenderer spriteRenderer, UnityEngine.Color targetColor, float duration, bool unscaled = false)
        {
        ...
        public ChangeColorToTween(Light light, UnityEngine.Color targetColor, float duration, bool unscaled = false)
        {
            _light = light;
        ...
        public ChangeColorToTween(Material material, UnityEngine.Color targetColor, float duration, bool unscaled = false)
        {
            _material = material;
